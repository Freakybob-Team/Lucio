...
class Polygon:
    def __init__(self, pos, pts, m, d, e, col, imm=0):
    ...
    def draw(self, surface):
        ...
        #pg.draw.circle(surface, "gray", self.pos, 2)
